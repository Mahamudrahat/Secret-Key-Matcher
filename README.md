...
## •	display: inline;
## o	Behavior: Elements do not start on a new line and only take up as much width as necessary.
## o	Box Model: Width and height cannot be set, only horizontal padding and margin are effective.
## •	display: inline-block;
## o	Behavior: Elements do not start on a new line but respect width and height settings.
## o	Box Model: Width, height, padding, and margin can be set and are respected.
## •	display: block;
## o	Behavior: Elements start on a new line and take up the full width available.
## o	Box Model: Width, height, padding, and margin can be set and are respected.
